<%@page import="com.liferay.populararticle.portlet.bean.MBMessageVO"%>
...
<%
	...
	MBMessageVO mbMessageObj = (MBMessageVO)resultRow.getObject();
	JournalArticle article = PopularArticleUtil.getLatestArticle(mbMessageObj.getClassPK());
